...
export async function notificationRoutes(app) {
    ...
    app.get('/notifications', async (request) => {
        ...
        const perPage = Math.min(MAX_PER_PAGE, Math.max(1, Number.parseInt(query.per_page ?? '15', 10) || 15));
        ...
        return ok(paginate(items, total, page, perPage, '/notifications/api/v1/notifications'), 'Notifications fetched successfully.');
    });
